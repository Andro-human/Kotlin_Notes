...
fun main() {
    ...
    println("Amount to be transferred is $money dollars.")

    fun withdraw(amount: Int): Int {
        accountBalance -= amount
        println("Money withdrawn: $amount. Updated balance: $accountBalance dollars.")
        return amount
    }
    
    fun debitWithdraw(amount: Int): Int {
        if (accountBalance == 0) {
            println("Can't withdrow, no money on this account!")
    ...
    fun deposit(amount: Int): Int {
        accountBalance += amount
        println("Money Deposited: $amount. Updated Balance: $accountBalance dollars.")
        return amount
    }
